...
% Last Modified by GUIDE v2.5 29-Oct-2017 16:09:28
...
pause(2)
       ...
       a=input_9';
        ...
        if a(12)>127
         ...
         z=[a(24)]
         q=[a(36)]
        table1= uitable( 'Data',[x z q],'ColumnName',{'X','Y','Z'},'Position',[550 300 400 50],'RowName',{'acceleration'});
       y(i:i)=x;
       plot(y,'Color',[0,1,0],'LineWidth',1.5)
          title('Valorile Acceleratiei')
          xlabel('Timp')
          ylabel('Valoare')
          grid
         drawnow
         hold on
         t(i:i)=z;
          plot(t,'Color',[0,0,1],'LineWidth',1.5)
         drawnow
         hold on
         u(i:i)=q;
         plot(u,'Color',[1,0,0],'LineWidth',1.5)
         drawnow
         hold off       
          end
         i=i+1;
...
data20=[1 146 253 6 0 0 64 0 1 0];
...
data21=[1 146 253 6 0 0 68 0 1 0];
